...
<div class="card">
    ...
    <h2 class="subtitle">Join us in reducing food waste</h2>
    <form id="registerForm" onsubmit="return validateRegister(event)">
        ...
        <label for="location"><i class="fas fa-map-marker-alt"></i> City / Location</label>
        <input type="text" id="location" name="location" placeholder="Enter your city or location" required/>
        <button type="submit" id="registerSubmit" class="btn-primary" disabled>
